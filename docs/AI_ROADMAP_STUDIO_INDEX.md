...
9. `docs/methodology/readiness_and_deployment_fit.md`
10. `docs/methodology/verification_model.md`
11. `docs/methodology/ROADMAP_CALCULATION_RU.md`
12. `docs/architecture/smb_roadmap_architecture.md`
13. `docs/prompts/roadmap_prompt_contracts.md`
14. `docs/tasks.md#phase-14-smb-ai-roadmap-product-layer`
15. `docs/CODEX_PROMPT.md`
