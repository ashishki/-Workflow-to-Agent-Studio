...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `Workflow-to-Agent Studio` with your project name._

```
You are a senior technical architect for Workflow-to-Agent Studio.
