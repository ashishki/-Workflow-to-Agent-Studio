...
_Copy to `docs/audit/PROMPT_1_ARCH.md` in your project. Replace `Workflow-to-Agent Studio` and adapt the Checks section to your architecture's layer rules and ADRs._

```
You are a senior architect for Workflow-to-Agent Studio.
