...
_Copy to `docs/audit/PROMPT_2_CODE.md` in your project. Replace `Workflow-to-Agent Studio` and adapt the Checklist section to your project's security requirements._

```
You are a senior security engineer for Workflow-to-Agent Studio.
