...
| HVAC-017 | https://www.mightyairinc.com/request-service/ | 2026-05-23 | request-service form | lead intake | Multi-step request flow requires fields unless marked optional and routes users through appointment request steps. | Historical locator returns HTTP 404 as of 2026-07-13; the captured claim cannot currently be rechecked from this URL. | true |
